defmodule ExperimentWeb.IngredientControllerTest do
  use ExperimentWeb.ConnCase

  alias Experiment.Ingredients

  @create_attrs %{ingredient_name: "some ingredient_name"}
  ...
  describe "update ingredient" do
    ...
    test "redirects when data is valid", %{conn: conn, ingredient: ingredient} do
      ...
      assert html_response(conn, 200) =~ "some updated ingredient_name"
    end
